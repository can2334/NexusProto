...
async function genQR(qr) {
  ...
  //   console.log(newMessages?.message?.messageContextInfo)

  // })

  // PushName'i burada database'e kaydetmek istemiştim ama mesajlar ilk yüklenirken pushname yerine rehberdeki name geliyor.
